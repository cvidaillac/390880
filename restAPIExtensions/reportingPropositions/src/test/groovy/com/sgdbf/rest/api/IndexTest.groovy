...
//        httpRequest.getParameter("budgetYear") >> "aValue3"
//
...
//        jsonResponse.budgetYear == "aValue3"
...
//    }
//
//    def should_return_an_error_response_if_budgetYear_is_not_set() {
//        given: "a request without budgetYear"
//        def index = new Index()
//        httpRequest.getParameter("budgetYear") >> null
//        // Other parameters return a valid value
//        httpRequest.getParameter("p") >> "aValue1"
//        httpRequest.getParameter("c") >> "aValue2"
//
...
//        // Validate returned response
//        apiResponse.httpStatus == 400
//        jsonResponse.error == "the parameter budgetYear is missing"
//    }
