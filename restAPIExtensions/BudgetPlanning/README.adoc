...
= Budget Planning
REST API to manage Budget Planning

The project **BudgetPlanning** is a Bonita REST API extension for **Bonita 7.12.4** version  **community** written in `groovy`
...
[source,bash]
----
git clone https://your.github.com/BudgetPlanning.git
cd BudgetPlanning/
mvn package
----

The build should produce a zip archive under the `target/` folder named `BudgetPlanning-1.0.0-SNAPSHOT.zip`
...
Take the built artifact `BudgetPlanning-1.0.0-SNAPSHOT.zip` and upload it to your Bonita platform (see https://documentation.bonitasoft.com/bonita/${shortBonitaVersion}/rest-api-extensions#toc7)
