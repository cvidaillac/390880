...
class IndexTest extends Specification {
    ...
    /*def should_return_a_json_representation_as_result() {
        ...
        httpRequest.getParameter("id") >> "aValue1"
        ...
        jsonResponse.id == "aValue1"
        jsonResponse.myParameterKey == "testValue"
    }

    def should_return_an_error_response_if_id_is_not_set() {
        given: "a request without id"
        def index = new Index()
        ...
        jsonResponse.error == "the parameter id is missing"
    }*/
