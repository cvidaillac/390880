...
class IndexTest extends Specification {
   ...
   /* def should_return_a_json_representation_as_result() {
        ...
        httpRequest.getParameter("sgid") >> "aValue1"
        ...
        jsonResponse.sgid == "aValue1"
        jsonResponse.myParameterKey == "testValue"
    }

    def should_return_an_error_response_if_sgid_is_not_set() {
        given: "a request without sgid"
        def index = new Index()
        httpRequest.getParameter("sgid") >> null
        ...
        jsonResponse.error == "the parameter sgid is missing"
    }*/
