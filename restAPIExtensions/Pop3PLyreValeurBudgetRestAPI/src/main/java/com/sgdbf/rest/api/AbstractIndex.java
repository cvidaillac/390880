...
public abstract class AbstractIndex implements RestApiController {
    ...
    public static final String PARAM_SOUSGENRE = "sousGenre";
    public static final String PARAM_EXERCICE = "exercice";
    public static final String PARAM_ENTITYCODE = "entityCode";
    ...
    public RestApiResponse doHandle(HttpServletRequest request, RestApiResponseBuilder responseBuilder, RestAPIContext context) {
        ...
        try {
            ...
            return jsonResponse(responseBuilder, SC_BAD_REQUEST, Error.builder().errorMsg(e.getMessage()).build());
        }
        ...
        Result result = execute(context, genre, sousGenre, exercice, entityCode);
    ...
    protected abstract Result execute(RestAPIContext context, String genre, String sousGenre, String exercice, String entityCode);
