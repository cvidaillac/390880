...
class IndexTest extends Specification {
    ...
    /*def should_return_a_json_representation_as_result() {
        ...
        httpRequest.getParameter("name") >> "aValue1"
        ...
        jsonResponse.name == "aValue1"
        jsonResponse.myParameterKey == "testValue"
    }

    def should_return_an_error_response_if_name_is_not_set() {
        given: "a request without name"
        def index = new Index()
        httpRequest.getParameter("name") >> null
        ...
        jsonResponse.error == "the parameter name is missing"
    }*/
