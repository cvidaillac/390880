...
public abstract class AbstractIndex implements RestApiController {
    ...
    protected abstract Result execute(RestAPIContext context) throws ValidationException, StartProcessException;

    protected abstract void validateInputParameters(HttpServletRequest request) throws ValidationException ;
