...
= Pop3P Lyre ParamFin
REST API to get params from Lyre

The project **Pop3PLyreParamFin** is a Bonita REST API extension for **Bonita 7.12.4** version  **community** written in `groovy`
...
[source,bash]
----
git clone https://your.github.com/Pop3PLyreParamFin.git
cd Pop3PLyreParamFin/
mvn package
----

The build should produce a zip archive under the `target/` folder named `Pop3PLyreParamFin-1.0.0-SNAPSHOT.zip`
...
Take the built artifact `Pop3PLyreParamFin-1.0.0-SNAPSHOT.zip` and upload it to your Bonita platform (see https://documentation.bonitasoft.com/bonita/${shortBonitaVersion}/rest-api-extensions#toc7)
