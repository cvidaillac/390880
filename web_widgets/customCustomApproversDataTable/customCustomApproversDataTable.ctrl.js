function PbDataTableCtrl($scope, $http, $log, $filter) {
  ...
  //Fonctions Custom pour traiter les propositions
  $scope.approve = function(proposition, event){
      //Empeche le selectedRow d'etre propagé :
     event.stopPropagation();
      
      var url = " ../API/extension/executeTask?taskId="+proposition.taskId;
      var sentObject = {"actionInput":"Validée","commentInput":""};
    ...
    $scope.reject = function(proposition){
      //Empeche le selectedRow d'etre propagé :
      event.stopPropagation();
      
      var url = " ../API/extension/executeTask?taskId="+proposition.taskId;
      var sentObject = {"actionInput":"Refusée","commentInput":""};
    ...
    $scope.askCompletion = function(proposition){
        //Empeche le selectedRow d'etre propagé :
        event.stopPropagation();
        $scope.properties.commentProposition=proposition;
    }
