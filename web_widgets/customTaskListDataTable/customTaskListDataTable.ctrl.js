function PbDataTableCtrl($scope, $http, $log, $filter) {
  ...
  //UAT : newDate() 
  var myDate = new Date();
$scope.currentDate = $filter('date')(myDate , "yyyy-MM-ddTHH:mm:ss+0000"); 
  //console.log($scope.currentDate,"currentDate");
  ...
  this.selectRowHandler = function (row) {
    ...
    //Redirect to the selected formPage
	var url = "/bonita/portal/form/taskInstance/"+row.id;
